...
public class PokemonFrontend {
    ...
    public void typeRankerPrompt() {
        ...
        topPokemon = ranker.bestOfType(type, false, num, false);
    ...
    public void counterRankerPrompt() {
        ...
        while (!valid) {
            ...
            topPokemon = new ArrayList<String>();
            counter = 1;
        ...
        defender = database.pokemons.get(finalPoke).createInstance(15, 15, 15, 40, shadow);
        valid = false;
        System.out.print("How many top counters would you like to see? ");
        ...
        topPokemon = ranker.bestCounters(defender, false, num);
